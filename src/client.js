...
class CommandoClient extends discord.Client {
	 ...
	 * @property {boolean} [mentionPrefix=false] - Whether to accept client user mention as prefix
	...
	constructor(options = {}) {
		...
		if(typeof options.mentionPrefix === 'undefined') options.mentionPrefix = false;
